...
scaling = 8
fiodir("../../../../../../../../storage/data/slwongag/GMERA/chern/systemsize$systemsize/nnhopping$nnhopping-localsize$scaling/testingwann")
...
for nooffilledmodes in range(60,144,15)
...
fiosave(wannierresult,name="wannierresult")
