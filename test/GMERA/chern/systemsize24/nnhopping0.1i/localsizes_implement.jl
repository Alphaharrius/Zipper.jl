...
for (scaling,noofrgsteps) in scalingswifnoofrgsteps
    ...
    rgH,rgcorrelations,couriercomposemap,gmeraapproximatecorrelationsofar,blockedcorrelations,noofflavourpermodeforlaterrg = firstgmerastep(correlations,H,scaling,systemsize,systemsize)
