...
function localwannierizationresult(blockedcorrelations)
    ...
    fiodir("../../../../data/testingwannierzation/entanglementcontour/localsize8")
    fiosave(groupedoffsetbyentanglementcontour, name="groupedoffsetbyentanglementcontour")
    for chosen in range(1,length(groupedoffsetbyentanglementcontour))
        ...
        fiosave(minsvd, name="minsvd_$chosen")
        fiosave(traceofsv, name="traceofsv_$chosen")
        fiosave(frozenseedsoffset, name="frozenseedsoffset_$chosen")
        fiosave(courierseedsoffset, name="courierseedsoffset_$chosen")
    end
end
