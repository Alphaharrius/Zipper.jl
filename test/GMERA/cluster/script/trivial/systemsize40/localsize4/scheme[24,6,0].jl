...
[onsitepotential for onsitepotential in range(-0.2,-0.1,2)]

for onsitepotential in range(-0.2,-0.1,2)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize4/scheme[24,6,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,24)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],6,4)
    gmera1thirdstepdata = gmerathirdstepbycount(gmera1secondstepdata[:couriercorrelations],0,1)
