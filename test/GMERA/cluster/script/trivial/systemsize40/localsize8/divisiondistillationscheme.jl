...
for onsitepotential in range(-1,-0.1,10)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize8/divisiondistillationscheme/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,192)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],96,32)
    gmera1thirdstepdata = gmerathirdstepbycount(gmera1secondstepdata[:couriercorrelations],0,16)
