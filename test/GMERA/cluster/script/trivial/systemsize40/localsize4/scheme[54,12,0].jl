...
for onsitepotential in range(-0.6,-0.1,6)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize4/scheme[54,12,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],12,9)
