...
for onsitepotential in range(-0.2,-0.1,2)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize8/scheme[204,60,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1thirdstepdata = gmerathirdstepbycount(gmera1secondstepdata[:couriercorrelations],0,10)
