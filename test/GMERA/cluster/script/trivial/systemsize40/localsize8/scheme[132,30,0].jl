...
for onsitepotential in range(-0.2,-0.1,2)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize8/scheme[132,30,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,132)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],30,22)
    gmera1thirdstepdata = gmerathirdstepbycount(gmera1secondstepdata[:couriercorrelations],0,5)
