...
innerhexagonalregion = rankedandgroupoffsets(firsthexagonalregion,4)
visualize(innerhexagonalregion)

courierseedsoffset = firsthexagonalregion-innerhexagonalregion
# intersect(siteAregion1,courierseedsoffset)|>visualize
# siteAregion1|>visualize
courierseedsoffset|>visualize
# courierseedsfock = quantize(courierseedsoffset,1)
courierseedsfock = quantize(courierseedsoffset,1)

intersect(intersect(courierseedsoffset,courierseedsoffset.+secondcenter),courierseedsoffset.+thirdcenter)|>visualize
    
localstates = getregionstates(localcorrelations=localcorrelations, grouping=[18,60,18])
...
# (localcourierisometry*localcourierisometry')[courierseedsfock,courierseedsfock]|>eigspech|>visualize

courierseeds = idmap(firsthexagonalregionfock, firsthexagonalregionfock)[:,FockSpace(mode for mode in courierseedsfock)]
localwanniercourier,minsvd,tr=localwannierization(localcourierisometry, courierseeds)

# filledseedsA1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteAregionfock1,siteAregionfock1]), grouping=[11,5])[2]
# filledseedsA2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteAregionfock2,siteAregionfock2]), grouping=[11,5])[2]
# filledseedsA3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteAregionfock3,siteAregionfock3]), grouping=[11,5])[2]
# filledseedsB1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteBregionfock1,siteBregionfock1]), grouping=[11,5])[2]
# filledseedsB2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteBregionfock2,siteBregionfock2]), grouping=[11,5])[2]
# filledseedsB3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteBregionfock3,siteBregionfock3]), grouping=[11,5])[2]
...
# emptyseedsA1 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteAregionfock1,siteAregionfock1]), grouping=[11,5])[2]
# emptyseedsA2 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteAregionfock2,siteAregionfock2]), grouping=[11,5])[2]
# emptyseedsA3 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteAregionfock3,siteAregionfock3]), grouping=[11,5])[2]
# emptyseedsB1 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteBregionfock1,siteBregionfock1]), grouping=[11,5])[2]
# emptyseedsB2 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteBregionfock2,siteBregionfock2]), grouping=[11,5])[2]
# emptyseedsB3 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteBregionfock3,siteBregionfock3]), grouping=[11,5])[2]
...
for hexagonalcenter in firstshiftedhexagonalcenters
    ...
    # filledseedsA1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteAregionfock1,shiftedsiteAregionfock1]), grouping=[11,5])[2]
    # filledseedsA2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteAregionfock2,shiftedsiteAregionfock2]), grouping=[11,5])[2]
    # filledseedsA3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteAregionfock3,shiftedsiteAregionfock3]), grouping=[11,5])[2]
    # filledseedsB1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteBregionfock1,shiftedsiteBregionfock1]), grouping=[11,5])[2]
    # filledseedsB2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteBregionfock2,shiftedsiteBregionfock2]), grouping=[11,5])[2]
    # filledseedsB3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteBregionfock3,shiftedsiteBregionfock3]), grouping=[11,5])[2]

    # filledseeds = (filledseedsA1+filledseedsA2+filledseedsA3+filledseedsB1+filledseedsB2+filledseedsB3)|>FockMap
    # localwannierfilled = localwannierization(localfilledisometry, filledseeds)

    # emptyseedsA1 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteAregionfock1,shiftedsiteAregionfock1]), grouping=[11,5])[2]
    # emptyseedsA2 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteAregionfock2,shiftedsiteAregionfock2]), grouping=[11,5])[2]
    # emptyseedsA3 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteAregionfock3,shiftedsiteAregionfock3]), grouping=[11,5])[2]
    # emptyseedsB1 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteBregionfock1,shiftedsiteBregionfock1]), grouping=[11,5])[2]
    # emptyseedsB2 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteBregionfock2,shiftedsiteBregionfock2]), grouping=[11,5])[2]
    # emptyseedsB3 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteBregionfock3,shiftedsiteBregionfock3]), grouping=[11,5])[2]

    # emptyseeds = (emptyseedsA1+emptyseedsA2+emptyseedsA3+emptyseedsB1+emptyseedsB2+emptyseedsB3)|>FockMap
    # localwannierempty = localwannierization(localemptyisometry, emptyseeds)

    # courierseedsA1 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteAregionfock1,shiftedsiteAregionfock1]), grouping=[12,4])[2]
    # courierseedsA2 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteAregionfock2,shiftedsiteAregionfock2]), grouping=[12,4])[2]
    # courierseedsA3 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteAregionfock3,shiftedsiteAregionfock3]), grouping=[12,4])[2]
    # courierseedsB1 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteBregionfock1,shiftedsiteBregionfock1]), grouping=[12,4])[2]
    # courierseedsB2 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteBregionfock2,shiftedsiteBregionfock2]), grouping=[12,4])[2]
    # courierseedsB3 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteBregionfock3,shiftedsiteBregionfock3]), grouping=[12,4])[2]

    # courierseeds = (courierseedsA1+courierseedsA2+courierseedsA3+courierseedsB1+courierseedsB2+courierseedsB3)|>FockMap

    innerhexagonalregion = rankedandgroupoffsets(shiftedfirsthexagonalregion,4)

    courierseedsoffset = shiftedfirsthexagonalregion-innerhexagonalregion
    courierseedsfock = quantize(courierseedsoffset,1)
...
# display(emptycorrelations|>eigspech|>visualize)
...
innerhexagonalregion = rankedandgroupoffsets(secondhexagonalregion,4)
visualize(innerhexagonalregion)

courierseedsoffset = secondhexagonalregion-innerhexagonalregion
# intersect(siteAregion1,courierseedsoffset)|>visualize
# siteAregion1|>visualize
courierseedsoffset|>visualize
# courierseedsfock = quantize(courierseedsoffset,1)
...
localstates = getregionstates(localcorrelations=localcorrelations, grouping=[15,30,15])
localcourierisometry = localstates[2]|>FockMap
localfilledisometry = localstates[1]|>FockMap
localemptyisometry = localstates[3]|>FockMap
...
# filledseedsA1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteAregionfock1,siteAregionfock1]), grouping=[4,2])[2]
# filledseedsA2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteAregionfock2,siteAregionfock2]), grouping=[4,2])[2]
# filledseedsA3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteAregionfock3,siteAregionfock3]), grouping=[4,2])[2]
# filledseedsB1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteBregionfock1,siteBregionfock1]), grouping=[4,2])[2]
# filledseedsB2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteBregionfock2,siteBregionfock2]), grouping=[4,2])[2]
# filledseedsB3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteBregionfock3,siteBregionfock3]), grouping=[4,2])[2]

# filledseeds = (filledseedsA1+filledseedsA2+filledseedsA3+filledseedsB1+filledseedsB2+filledseedsB3)|>FockMap
# localwannierfilled = localwannierization(localfilledisometry, filledseeds)

# emptyseedsA1 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteAregionfock1,siteAregionfock1]), grouping=[4,2])[2]
# emptyseedsA2 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteAregionfock2,siteAregionfock2]), grouping=[4,2])[2]
# emptyseedsA3 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteAregionfock3,siteAregionfock3]), grouping=[4,2])[2]
# emptyseedsB1 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteBregionfock1,siteBregionfock1]), grouping=[4,2])[2]
# emptyseedsB2 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteBregionfock2,siteBregionfock2]), grouping=[4,2])[2]
# emptyseedsB3 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[siteBregionfock3,siteBregionfock3]), grouping=[4,2])[2]

# emptyseeds = (emptyseedsA1+emptyseedsA2+emptyseedsA3+emptyseedsB1+emptyseedsB2+emptyseedsB3)|>FockMap
# localwannierempty = localwannierization(localemptyisometry, emptyseeds)

# courierseedsA1 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[siteAregionfock1,siteAregionfock1]), grouping=[6,2])[2]
# courierseedsA2 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[siteAregionfock2,siteAregionfock2]), grouping=[6,2])[2]
# courierseedsA3 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[siteAregionfock3,siteAregionfock3]), grouping=[6,2])[2]
# courierseedsB1 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[siteBregionfock1,siteBregionfock1]), grouping=[6,2])[2]
# courierseedsB2 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[siteBregionfock2,siteBregionfock2]), grouping=[6,2])[2]
# courierseedsB3 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[siteBregionfock3,siteBregionfock3]), grouping=[6,2])[2]
...
for hexagonalcenter in secondshiftedhexagonalcenterlist
    ...
    # filledseedsA1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteAregionfock1,shiftedsiteAregionfock1]), grouping=[4,2])[2]
    # filledseedsA2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteAregionfock2,shiftedsiteAregionfock2]), grouping=[4,2])[2]
    # filledseedsA3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteAregionfock3,shiftedsiteAregionfock3]), grouping=[4,2])[2]
    # filledseedsB1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteBregionfock1,shiftedsiteBregionfock1]), grouping=[4,2])[2]
    # filledseedsB2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteBregionfock2,shiftedsiteBregionfock2]), grouping=[4,2])[2]
    # filledseedsB3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[shiftedsiteBregionfock3,shiftedsiteBregionfock3]), grouping=[4,2])[2]

    # filledseeds = (filledseedsA1+filledseedsA2+filledseedsA3+filledseedsB1+filledseedsB2+filledseedsB3)|>FockMap
    # localwannierfilled = localwannierization(localfilledisometry, filledseeds)

    # emptyseedsA1 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteAregionfock1,shiftedsiteAregionfock1]), grouping=[4,2])[2]
    # emptyseedsA2 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteAregionfock2,shiftedsiteAregionfock2]), grouping=[4,2])[2]
    # emptyseedsA3 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteAregionfock3,shiftedsiteAregionfock3]), grouping=[4,2])[2]
    # emptyseedsB1 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteBregionfock1,shiftedsiteBregionfock1]), grouping=[4,2])[2]
    # emptyseedsB2 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteBregionfock2,shiftedsiteBregionfock2]), grouping=[4,2])[2]
    # emptyseedsB3 = getregionstates(localcorrelations=((localemptyisometry*localemptyisometry')[shiftedsiteBregionfock3,shiftedsiteBregionfock3]), grouping=[4,2])[2]

    # emptyseeds = (emptyseedsA1+emptyseedsA2+emptyseedsA3+emptyseedsB1+emptyseedsB2+emptyseedsB3)|>FockMap
    # localwannierempty = localwannierization(localemptyisometry, emptyseeds)

    # courierseedsA1 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteAregionfock1,shiftedsiteAregionfock1]), grouping=[6,2])[2]
    # courierseedsA2 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteAregionfock2,shiftedsiteAregionfock2]), grouping=[6,2])[2]
    # courierseedsA3 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteAregionfock3,shiftedsiteAregionfock3]), grouping=[6,2])[2]
    # courierseedsB1 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteBregionfock1,shiftedsiteBregionfock1]), grouping=[6,2])[2]
    # courierseedsB2 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteBregionfock2,shiftedsiteBregionfock2]), grouping=[6,2])[2]
    # courierseedsB3 = getregionstates(localcorrelations=((localcourierisometry*localcourierisometry')[shiftedsiteBregionfock3,shiftedsiteBregionfock3]), grouping=[6,2])[2]

    innerhexagonalregion = rankedandgroupoffsets(shiftedsecondhexagonalregion,4)

    courierseedsoffset = shiftedsecondhexagonalregion-innerhexagonalregion
    # intersect(siteAregion1,courierseedsoffset)|>visualize
    # siteAregion1|>visualize
    # courierseedsfock = quantize(courierseedsoffset,1)
    courierseedsfock = quantize(courierseedsoffset,1)
...
courierH2 = wanniercourierisometry'courierH*wanniercourierisometry
courierH2|>crystalspectrum|>visualize
# display(couriercorrelations|>eigspech|>visualize)
...
thirdhexagonalregion|>visualize
...
localstates = getregionstates(localcorrelations=localcorrelations, grouping=[12,6,12])
localcourierisometry = localstates[2]|>FockMap
localfilledisometry = localstates[1]|>FockMap
localemptyisometry = localstates[3]|>FockMap
# localemptyisometry'*localcorrelations*localemptyisometry|>eigspech|>visualize

# (localfilledisometry*localfilledisometry')[siteAregionfock1,siteAregionfock1]|>eigspech|>visualize
# (localcourierisometry*localcourierisometry')[siteAregionfock1,siteAregionfock1]|>eigspech|>visualize

innerhexagonalregion = rankedandgroupoffsets(thirdhexagonalregion,3)

courierseedsoffset = thirdhexagonalregion-innerhexagonalregion
...
filledH3=wannierfilledisometry' * courierH2 * wannierfilledisometry
filledH3|>crystalspectrum|>visualize
...
thirdgmeracrystalfock = thirdgmeracorrelations|>getoutspace
...
finalcenter = [1/3,1/3] ∈ thirdgmeraspace
finalhexagonalregion = gethexagonalregion(rot = refrot,crystal=thirdgmeracrystal, center=finalcenter, metricspace=thirdgmeraspace)
finalhexagonalregionfock = quantize(finalhexagonalregion,noofflavourpermode)
rgshiftedcenter1 = [2/3,-1/3] ∈ thirdgmeraspace
finalrgshiftedhexagonalregion1 = finalhexagonalregion.+rgshiftedcenter1
rgshiftedcenter2 = [1/3,1/3] ∈ thirdgmeraspace
finalrgshiftedhexagonalregion2 = finalhexagonalregion.+rgshiftedcenter2

c6recenter = recenter(c6,finalcenter)
c3recenter = recenter(c3,finalcenter)

siteAregion1 = intersect(intersect(finalhexagonalregion,finalrgshiftedhexagonalregion1),finalrgshiftedhexagonalregion2)
siteAregionfock1 = quantize(siteAregion1,noofflavourpermode)
siteAregion2 = (c3recenter)*siteAregion1
siteAregionfock2 = quantize(siteAregion2,noofflavourpermode)
siteAregion3 = (c3recenter)*siteAregion2
...
localcorrelations = regioncorrelations(thirdgmeracorrelations,finalhexagonalregionfock)
localspectrum = localcorrelations|>eigspech
display(localspectrum|>visualize)

localsiteA1correlations = regioncorrelations(thirdgmeracorrelations,siteAregionfock1)
localsiteA2correlations = regioncorrelations(thirdgmeracorrelations,siteAregionfock2)
localsiteA3correlations = regioncorrelations(thirdgmeracorrelations,siteAregionfock3)
localsiteB1correlations = regioncorrelations(thirdgmeracorrelations,siteBregionfock1)
localsiteB2correlations = regioncorrelations(thirdgmeracorrelations,siteBregionfock2)
localsiteB3correlations = regioncorrelations(thirdgmeracorrelations,siteBregionfock3)
localsiteB1correlations|>eigspec|>geteigenvalues

# gmeracorrelations = purifiedcouriercorrelations
...
# gmeraunitcell = gmeracrystal|>getunitcell
# gmeraseedingfock::RegionFock = quantize(gmeraunitcell, 1)
# gmerarscorrelations = regioncorrelations(gmeracorrelations,gmeraseedingfock)
# gmerarscorrelations[[m for m in gmeraseedingfock][2],[m for m in gmeraseedingfock][2]]|>eigspech|>geteigenvalues