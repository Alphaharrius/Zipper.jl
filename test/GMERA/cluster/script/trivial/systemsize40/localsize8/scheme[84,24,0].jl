...
for onsitepotential in range(-1,-0.1,10)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize8/scheme[84,24,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,84)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],24,14)
