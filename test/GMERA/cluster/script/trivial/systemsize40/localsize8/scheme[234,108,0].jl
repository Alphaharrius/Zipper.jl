...
for onsitepotential in range(-0.2,-0.1,2)
    fiodir("../../../../data/trivial/systemsize40/localsize8/maximumdistillationscheme/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,234)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],108,39)
    gmera1thirdstepdata = gmerathirdstepbycount(gmera1secondstepdata[:couriercorrelations],0,18)
