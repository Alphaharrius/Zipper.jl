...
function listofapprox(rgresults)
    ...
    if haskey(rgresults[finalrg],:correlations)
        ...
        ref = [rgresult[2][:approximation] for rgresult in rgresults]
        return ref
    else
        return [rgresult[2][:approximation] for rgresult in rgresults]
    end
end
...
function H_dirac(systemsize::Number,tₙ::Number)
...
H_size12, correlations_size12 = H_dirac(12,ComplexF64(-1))
fiodir("../../../../ZERData/GMERA/threshold_1_002/semi_metal")
...
rgapproxloc2size12test = rgapproximation(rgresultsloc2size12)
fiosave(rgapproxloc2size12, name="rgapproxloc2size12")

rgresultsloc2size12
[r for r in range(1,10) ][2:end]
[rgresult[2][:approximation]+rgresult[2][:approximation] for rgresult in rgresultsloc2size12][end]
...
H_size24, correlations_size24 = H_dirac(24,ComplexF64(-1))
...
H_size48, correlations_size48 = H_dirac(48,ComplexF64(-1))
...
blockedcorrelationsloc2size48- rgapproxloc2size48
...
# H_size96, correlations_size96 = H_dirac(96,ComplexF64(-1))
...
# H_size192, correlations_size192 = H_dirac(192,ComplexF64(-1))
