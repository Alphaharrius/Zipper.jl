...
for onsitepotential in range(-1,-0.1,10)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize8/scheme[228,102,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,228)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],102,38)
    gmera1thirdstepdata = gmerathirdstepbycount(gmera1secondstepdata[:couriercorrelations],0,17)
