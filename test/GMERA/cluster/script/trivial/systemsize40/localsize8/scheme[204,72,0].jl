...
for onsitepotential in range(-0.2,-0.1,2)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize8/scheme[204,72,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,204)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],60,34)
    gmera1thirdstepdata = gmerathirdstepbycount(gmera1secondstepdata[:couriercorrelations],0,12)
