...
- `outspace` The output `FockSpace` of this map. If this object is the multiplier, then this will be the `outspace` of the 
             ...
             multiplier.
- `inspace`  The input `FockSpace` of this map. If this object is the multiplier, then must have the same span as the 
             `outspace` of the multiplier; if this object is the factor, then this will be the `inspace` of the resulting 
             `FockMap`.
...
function SparseFockMap(
    outspace::FockSpace, inspace::FockSpace, mapping::Dict{Tuple{Mode, Mode}, T})::SparseFockMap where {T <: Complex}
...
FockMap(outspace::FockSpace, inspace::FockSpace, rep::SparseMatrixCSC{ComplexF64, Int64}) = (
    SparseFockMap(outspace, inspace, rep))
FockMap(outspace::FockSpace, inspace::FockSpace, rep::AbstractArray{<:Number}) = (
    SparseFockMap(outspace, inspace, rep))
FockMap(outspace::FockSpace, inspace::FockSpace, mapping::Dict{Tuple{Mode, Mode}})::SparseFockMap = (
...
# ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
# ◆ SparseFockMap arithmetics ◆
Base.broadcasted(::typeof(+), left::SparseFockMap, right::SparseFockMap) = (
    SparseFockMap(left|>getoutspace, left|>getinspace, rep(left)+rep(right)))
# ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
