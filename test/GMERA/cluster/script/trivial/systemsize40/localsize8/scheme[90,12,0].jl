...
for onsitepotential in range(-0.2,-0.1,2)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize8/scheme[90,12,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,90)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],12,15)
