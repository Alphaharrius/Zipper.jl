...
for onsitepotential in range(-1,-0.1,10)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize4/scheme[54,30,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],30,9)
