...
[onsitepotential for onsitepotential in reverse([onsite for onsite in range(-0.1,-0.1,1)])]

for onsitepotential in reverse([onsite for onsite in range(-0.1,-0.1,1)])
# onsitepotential = -1
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize8/maximumdistillationscheme[48,12,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,48)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],12,8)
    gmera1thirdstepdata = gmerathirdstepbycount(gmera1secondstepdata[:couriercorrelations],0,2)
