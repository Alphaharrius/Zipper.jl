...
# filledseedsA1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteAregionfock1,siteAregionfock1]), grouping=[3,1])[2]
# filledseedsA2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteAregionfock2,siteAregionfock2]), grouping=[3,1])[2]
# filledseedsA3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteAregionfock3,siteAregionfock3]), grouping=[3,1])[2]
# # filledseedsB1 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteBregionfock1,siteBregionfock1]), grouping=[3,1])[2]
# # filledseedsB2 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteBregionfock2,siteBregionfock2]), grouping=[3,1])[2]
# # filledseedsB3 = getregionstates(localcorrelations=((localfilledisometry*localfilledisometry')[siteBregionfock3,siteBregionfock3]), grouping=[3,1])[2]
...
for hexagonalcenter in firstshiftedhexagonalcenters
    ...
    courierseedsoffset = shiftedfirsthexagonalregion-test
    # intersect(siteAregion1,courierseedsoffset)|>visualize
    # siteAregion1|>visualize
    courierseedsoffset|>visualize
    # courierseedsfock = quantize(courierseedsoffset,1)
...
filledH = wannierfilledisometry' * blockedH * wannierfilledisometry
filledH|>crystalspectrum|>visualize

emptycorrelations = wannieremptyisometry' * blockedcorrelations * wannieremptyisometry
emptyH = wannieremptyisometry' * blockedH * wannieremptyisometry
...
courierseedsoffset = secondhexagonalregion-test
# intersect(siteAregion1,courierseedsoffset)|>visualize
# siteAregion1|>visualize
courierseedsoffset|>visualize
# courierseedsfock = quantize(courierseedsoffset,1)
...
for hexagonalcenter in secondshiftedhexagonalcenterlist
    ...
    courierseedsoffset = shiftedsecondhexagonalregion-test
    courierseedsoffset|>visualize
    courierseedsfock = quantize(courierseedsoffset,1)
...
filledH2 = wannierfilledisometry' * courierH * wannierfilledisometry
filledH2|>crystalspectrum|>visualize

emptycorrelations = wannieremptyisometry' * firstgmeracorrelations * wannieremptyisometry
emptyH2 = wannieremptyisometry' * courierH * wannieremptyisometry
emptyH2|>crystalspectrum|>visualize
...
courierseedsoffset = thirdhexagonalregion-test
# intersect(siteAregion1,courierseedsoffset)|>visualize
# siteAregion1|>visualize
courierseedsoffset|>visualize
# courierseedsfock = quantize(courierseedsoffset,1)
...
H|>crystalspectrum|>visualize
courierH3 = wanniercourierisometry' * courierH2 * wanniercourierisometry
courierH3|>crystalspectrum|>visualize
...
rgedcorrelations = purifiedcouriercorrelations
rgedcrystalfock = rgedcorrelations|>getoutspace
...
@info("Performing rgblocking on correlations...")
blockedrgedcorrelations = @time blocker * rgedcorrelations * blocker'

blockedrgedcrystal = blockedrgedcorrelations|>getoutspace|>getcrystal
blockedrgedcrystalfock = blockedrgedcorrelations|>getoutspace
blockedrgedspace::RealSpace = blockedrgedcrystal|>getspace

refrot = inv([2/3 -1/3; -1/3 2/3]')
c6 = pointgrouptransform([cos(π/3) -sin(π/3); sin(π/3) cos(π/3)])
c3 = c6^2

firstcenter = [0,0] ∈ blockedrgedspace
firsthexagonalregion = gethexagonalregion(rot = refrot,crystal=blockedrgedcrystal, center=firstcenter, metricspace=blockedrgedspace)
firsthexagonalregionfock = quantize(firsthexagonalregion,1)
rgshiftedcenter1 = [2/3,-1/3] ∈ blockedrgedspace
firstrgshiftedhexagonalregion1 = firsthexagonalregion.+rgshiftedcenter1
rgshiftedcenter2 = [1/3,1/3] ∈ blockedrgedspace
firstrgshiftedhexagonalregion2 = firsthexagonalregion.+rgshiftedcenter2
...
localcorrelations = regioncorrelations(blockedrgedcorrelations,firsthexagonalregionfock)
localspectrum = localcorrelations|>eigspec
localspectrum|>visualize