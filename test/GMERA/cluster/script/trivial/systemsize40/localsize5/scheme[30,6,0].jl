...
for onsitepotential in range(-0.2,-0.2,1)
    fiodir("/Users/slwongag/Desktop/data/trivial/systemsize40/localsize5/scheme[30,6,0]/onsitepotential_$onsitepotential")
    systemsize=40
    ...
    gmera1firststepdata = gmerafirststepbycount(blockedcorrelations,30)
    gmera1secondstepdata = gmerasecondstepbycount(gmera1firststepdata[:couriercorrelations],6,5)
